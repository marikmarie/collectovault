            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" value={points} onChange={e => setPoints(parseInt(e.target.value) || 0)} className="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Price (UGX)</label>
                        <input type="number" value={price} onChange={e => setPrice(parseInt(e.target.value) || 0)} className="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500" />
                    </div>
